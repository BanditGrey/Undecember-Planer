...
const dict = {
  pt: {
    ...
    presetsTitle: 'Builds iniciais', presetsHint: 'modelos para começar — abra, ajuste as cores dos slots e evolua', shortcuts: 'Atalhos: 1–8 abas · Ctrl+Z/Y desfazer/refazer · Ctrl+S salvar',
  ...
  en: {
    ...
    presetsTitle: 'Starter builds', presetsHint: 'templates to begin with — open, adjust slot colours and grow', shortcuts: 'Shortcuts: 1–8 tabs · Ctrl+Z/Y undo/redo · Ctrl+S save',
