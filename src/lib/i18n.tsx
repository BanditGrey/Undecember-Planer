...
const dict = {
  pt: {
    ...
    help6: 'No planner: clique nos pontos ao redor da skill para ciclar a cor do slot (indefinido → R → G → B → Branco → fechado). Slot indefinido não é validado. O botão N/M/R/L define o grau da runa.',
  ...
  en: {
    ...
    help6: 'In the planner: click the dots around a skill to cycle the slot colour (unset → R → G → B → White → closed). Unset slots are not validated. The N/M/R/L button sets the rune grade.',
