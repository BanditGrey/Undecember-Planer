...
const dict = {
  pt: {
    ...
    tabGallery: 'Galeria', galleryTitle: 'Galeria da comunidade', galleryHint: 'builds publicadas como issues no GitHub', publish: 'Publicar build atual', search: 'Buscar…', allStats: 'Todos os atributos', loading: 'Carregando…', galleryErr: 'Não foi possível carregar a galeria', galleryEmpty: 'Nenhuma build publicada ainda. Seja o primeiro!', galleryFoot: 'Publicar abre uma issue pré-preenchida no GitHub (precisa de conta GitHub). Curta com 👍 e comente na própria issue. Fonte:',
  ...
  en: {
    ...
    tabGallery: 'Gallery', galleryTitle: 'Community gallery', galleryHint: 'builds published as GitHub issues', publish: 'Publish current build', search: 'Search…', allStats: 'All stats', loading: 'Loading…', galleryErr: 'Could not load the gallery', galleryEmpty: 'No builds published yet. Be the first!', galleryFoot: 'Publishing opens a pre-filled GitHub issue (GitHub account required). Upvote with 👍 and discuss in the issue. Source:',
