...
- **Zodíaco (Especializações)** – aba própria com as 24 especializações oficiais (6 rotas × Ⅰ/Ⅱ/Ⅲ: Aço/Tristeza/Tipan/Tocha, Martelo/Ira/Chama/Fogueira, Respiração/Cadáver/Carrasco/Fogo-fátuo, Escuridão/Stra/Pescador/Veleiro, Brilho/Vácuo/Cachoeira/Pirata, Alvorada/Granizo/Monção/Simpatia), 504 nós Lua/Estrela/Sol/Cosmos desenhados como constelações, regra de pré-requisito por linha e limite de pontos (7/7/9). Transcrito das notas oficiais de 9/jan/2025 (`db/zodiac.json`); os nós ativos viajam junto no link da build.
